    ...
    <div style={{ padding: '1.5rem' }} className="fade-in">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem', marginBottom: '1.5rem' }}>
        ...
        <div className="rpg-card" style={{ padding: '1rem', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '1.75rem', fontWeight: 'bold', fontFamily: 'var(--font-serif)', color: weightChange === null ? 'hsl(var(--muted-foreground))' : weightChange > 0 ? 'hsl(0 70% 55%)' : 'hsl(160 60% 50%)' }}>
        ...
        <div className="rpg-card" style={{ padding: '1.25rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            ...
            <button onClick={() => addMutation.mutate()} disabled={!form.weightKg || addMutation.isPending}
              style={{ padding: '0.625rem', borderRadius: '0.5rem', fontWeight: 'bold', fontFamily: 'var(--font-serif)', border: 'none', cursor: form.weightKg ? 'pointer' : 'not-allowed', background: !form.weightKg ? 'hsl(var(--muted))' : 'linear-gradient(135deg, hsl(43 85% 45%), hsl(43 85% 60%))', color: !form.weightKg ? 'hsl(var(--muted-foreground))' : 'hsl(220 20% 6%)' }}>
          ...
          {chartData.length < 2 ? (
            ...
            <ResponsiveContainer width="100%" height={200}>
              <LineChart data={chartData}>
                ...
                <Line type="monotone" dataKey="peso" stroke="hsl(43 85% 55%)" strokeWidth={2} dot={{ fill: 'hsl(43 85% 55%)', r: 4 }} />
              </LineChart>
            </ResponsiveContainer>
          )}
        </div>
