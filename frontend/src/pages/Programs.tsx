...
const DIFF_COLORS: Record<string,string> = { beginner:'hsl(160 60% 50%)', intermediate:'hsl(43 85% 55%)', advanced:'hsl(0 70% 55%)' };
  ...
  return (
    <div style={{ padding:'1.5rem' }} className="fade-in">
      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'1.5rem' }}>
        ...
        <button onClick={() => setCreating(true)} style={{ padding:'0.5rem 1rem', borderRadius:'0.5rem', fontWeight:'bold', fontFamily:'var(--font-serif)', border:'none', cursor:'pointer', background:'linear-gradient(135deg, hsl(43 85% 45%), hsl(43 85% 60%))', color:'hsl(220 20% 6%)' }}>📖 Nuovo</button>
      </div>
